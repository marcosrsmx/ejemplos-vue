<template>
  <div class="home row">
    ...
    <div class="col-md-9">
      ...
      <labelcustom title="Componentes"></labelcustom>
      
      <ComponentCycle></ComponentCycle>
      <!--     
      <h2>Componente contenido en otro componente</h2>
      <componentUno></componentUno>
      --martes
      <ComponentFor></ComponentFor>
      <ComponentClass></ComponentClass>
      <ChildComponent title="Bienvenido"></ChildComponent>
      <ParentComponent></ParentComponent>
      --jueves
      <ComponentComputed></ComponentComputed>
      <ComponentWatch></ComponentWatch>
      <ComponentWatchEffect></ComponentWatchEffect>

      <ComponentForm></ComponentForm>
      <ComponentFormEdo></ComponentFormEdo>
